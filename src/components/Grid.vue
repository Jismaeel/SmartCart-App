<template>
  <div class="bg-black py-8 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-center text-base/7 font-semibold text-green-400">
        Features of the SmartCart App
      </h2>
      <p
        class="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance text-gray-500 sm:text-5xl"
      >
        ...
        <div class="relative lg:row-span-2">
          ...
          >
            <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
              ...
              >
                The user-interface is simple and easy to use for all ages.
              </p>
            </div>
            <div
          ...
          >
            <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
              ...
              <p
                class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center"
              >
                Create your list and Manage it.
              </p>
            </div>
