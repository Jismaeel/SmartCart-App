<template>
  <div class="bg-black">
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      >
        <div
          class="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#87ff6f] to-[#00a015] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
          style="
            clip-path: polygon(
              74.1% 44.1%,
              100% 61.6%,
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-28">
        ...
        <div class="text-center">
          <h1
            class="text-5xl font-semibold tracking-tight text-balance text-green-400 sm:text-7xl"
          >
          ...
          >
            Download the app for free on the Google PlayStore or just Download
            it on our website.
          </p>
      ...
      >
        <div
          class="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#00ff62] to-[#00310c] opacity-30 sm:left-[calc(50%+36rem)] sm:w-288.75"
          style="
            clip-path: polygon(
              74.1% 44.1%,
              100% 61.6%,
